...
"""
#sheet 2
triggers2 = {"Число ПОКУПАТЕЛЕЙ в ЭГ за период":'id_cli',
...
#sheet 3,4
triggers3 = {'email' : {'Триггер 1. Брошенная корзина': 'Брошенная корзина email',
...
#sheet 3
attr3 = {'preview_url':'Ссылка на визуал',
